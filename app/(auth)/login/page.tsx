  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-50 px-6 py-16">
      <form action={login} className="w-full max-w-md rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
        ...
        <button className="mt-6 w-full rounded-lg bg-zinc-900 px-4 py-2.5 text-sm font-medium text-white hover:bg-zinc-700" type="submit">Entrar</button>
        <p className="mt-6 text-center text-sm text-zinc-500">Ainda não tem conta? <Link className="font-medium text-zinc-900 underline" href="/cadastro">Criar conta</Link></p>
      </form>
    </main>
  );
}