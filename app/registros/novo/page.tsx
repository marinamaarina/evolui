        ...
        <div className="mt-6 rounded-2xl border border-zinc-200 bg-white p-8 shadow-sm">
          ...
          <form action={createRecord} className="mt-8 space-y-5">
            <div>
              ...
              <select className="mt-2 w-full rounded-lg border border-zinc-300 bg-white px-3 py-2.5 text-sm outline-none focus:border-zinc-900" id="type" name="type" required defaultValue="">
            ...
            <div>
              ...
              <input className="mt-2 w-full rounded-lg border border-zinc-300 px-3 py-2.5 text-sm outline-none focus:border-zinc-900" id="activityName" name="activityName" placeholder="Ex.: Corrida de 5 km" type="text" maxLength={120} />
            </div>

            <div>
              <label className="block text-sm font-medium text-zinc-700" htmlFor="recordDate">Data</label>
              <input className="mt-2 w-full rounded-lg border border-zinc-300 px-3 py-2.5 text-sm outline-none focus:border-zinc-900" id="recordDate" name="recordDate" type="date" required />
            </div>

            <div>
              <label className="block text-sm font-medium text-zinc-700" htmlFor="notes">Observações</label>
              <textarea className="mt-2 min-h-32 w-full resize-y rounded-lg border border-zinc-300 px-3 py-2.5 text-sm outline-none focus:border-zinc-900" id="notes" name="notes" placeholder="Como foi essa experiência?" maxLength={2000} />
            </div>
